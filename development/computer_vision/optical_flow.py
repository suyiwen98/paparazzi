...
def extract_flow_information(image_dir_path, df, verbose=True, graphics=True, flow_graphics=False):
    ...
    for im in np.arange(start, end, 1):
        ...
        if im > start:
            ...
            points_old, points_new, flow_vectors = determine_optical_flow(prev_bgr, bgr, prev_bgr_time, bgr_time,
                                                                          graphics=flow_graphics)
            ...
            if verbose:
                ...
                print('error = {}, FoE = {}, {}, Time to Contact ={}, and Divergence = {}'.format(err, FoE[0], FoE[1],
                                                                                                  time_to_contact,
                                                                                                  divergence))
        #            except:
